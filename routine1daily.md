...
Score every held position and candidate 0–10 using the latest reported quarterly
results from official filings or verified earnings releases only. If a metric
cannot be verified, award 0 for that metric. Do not infer or estimate.

  Revenue Growth (0–2 pts)
    ≥25% YoY: 2 pts  |  15–24.9% YoY: 1 pt  |  <15%: 0 pts

  Earnings or Cash-Flow Growth (0–2 pts)
    When both current and prior-year diluted EPS are positive:
      EPS growth ≥25% YoY: 2 pts  |  10–24.9%: 1 pt  |  <10%: 0 pts
    When either EPS value is negative, use free cash flow instead:
  ...
  Balance-Sheet Quality (0–1 pt)
    Net cash position, OR positive FCF with net debt <2× trailing FCF: 1 pt
